...
async function processAction(msg, cfg) {
  ...
  if (dimension === 'ROWS') {
    ...
    if (isRowDataPresent === 0) {
      ...
      this.logger.info('New row successfully written to spreadsheet');
    } else {
      ...
      this.logger.info('Row in spreadsheet updated successfully');
    }
    ...
    if (isColumnDataPresent === 0) {
      ...
      this.logger.info('New column successfully written to spreadsheet');
    } else {
      ...
      this.logger.info('Column in spreadsheet updated successfully');
    }
  } else {
