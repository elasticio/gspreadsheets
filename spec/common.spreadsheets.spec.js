describe('Common function listSpreadsheets', () => {
  ...
  it('Should provide message if no credentials is set', () => {
  ...
  it('should react on auth errors when refreshing token', () => {
    // Refresh token
  ...
  it('should react on errors when fetching resource', () => {
    // Refresh token
    nock('https://www.googleapis.com')
      .post('/oauth2/v4/token', {
        grant_type: 'refresh_token',
  ...
  it('should list spreadsheets', () => {
    ...
    runs(() => {
      ...
      const result = cb.calls[0].args[1];
      // Four spreadsheets
