describe('Common function', function () {
    ...
    describe('listSpreadsheets', function() {
    ...
    describe('getMetaModel', function() {
        ...
        it('should react on errors when fetching resource', function () {
            ...
            nock('https://sheets.googleapis.com')
                .get('/v4/spreadsheets/spreadsheetID/values/1:3?majorDimension=ROWS&dateTimeRenderOption=FORMATTED_STRING')
                .reply(500, 'Server error');

            common.getMetaModel.call(that, cfg, cb);
        ...
        it('should return metamodel', function () {
            ...
            nock('https://sheets.googleapis.com')
                .get('/v4/spreadsheets/spreadsheetID/values/1:3?majorDimension=ROWS&dateTimeRenderOption=FORMATTED_STRING')
                .replyWithFile(200, __dirname + '/data/rows.json');
            ...
            runs(function () {
                ...
                var result = cb.calls[0].args[1];
                expect(Object.keys(result).length).toEqual(2);
                expect(Object.keys(result.in)).toEqual([]);
                expect(Object.keys(result.out)).toEqual([ 'type', 'properties' ]);
                expect(result.out.type).toEqual('object');
                expect(Object.keys(result.out.properties)).toEqual([ 'rowIndex', 'col0', 'col1', 'col2', 'col3', 'col4', 'col5', 'col6', 'col7', 'col8', 'col9', 'col10', 'col11', 'col12' ]);
            });
        });
